                ...
                <tr>
                    <td width="600" style="border:1px solid #71CAEA;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td height="21" style="background:#e91362;font-size:20px; font-weight:bold; color:#ffffff; font-family:Open Sans; padding:0px 20px;"><strong>Login Credential</strong></td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
                            ...
                            <td height="10"></td>
                             ...
                             <tr>
                                <td height="20" style="padding:0px 20px;">Please use below credential to login in delivery person app.
                            ...
                            <tr><td height="20" style="padding:0px 20px;"><b> Email: </b>{{$email}}</td></tr>
                             <tr>
                             <td height="10"></td>
                             </tr>
