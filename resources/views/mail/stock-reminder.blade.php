                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="73" style="background:#FFFFFF; padding-left:20px;">
                                    <a target="_blank"  src="{{asset('img/logo.png')}}">
                                    <img src="{{asset('img/logo.png')}}">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td height="21" style="background:#e91362;font-size:20px; font-weight:bold; color:#ffffff; font-family:Open Sans; padding:0px 20px;"><strong>Order Delivered</strong></td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
                            ...
                            <tr>
                                <td height="20" style="padding:0px 20px;">Please check current stock of  {{$product}} in franchise {{$franchise}} and try to refill to keep up to date stock for further orders</td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
