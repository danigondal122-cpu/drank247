...
@else
    ...
    <body class="hold-transition">
        ...
        <h1 style="text-align:center;color:#e91362;margin:30px;">Your Reset Password link is Expired!!<br>
            <a href="{{ url('admin/login') }}"><button type="button" class="btn" style="width:30%;margin-top:30px;background-color:#e91362;color:#fff;">Go to Login page</button></a>
        </h1>
