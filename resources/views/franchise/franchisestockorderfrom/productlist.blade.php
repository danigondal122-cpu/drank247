     ...
     columns: [
      {
          "mRender": function ( data, type, row ) {
            let html = "<input type='checkbox' class='simple checksingle' id="+row.product_id+" name='checksingle[]' value="+row.product_id+">";
            return html;
          }
        },
        { data: 'product_name' },
        { data: 'product_articleNumber' },
        {
          "mRender": function ( data, type, row ) {
            let html = "<div name=stock"+row.product_id+" id=stock"+row.product_id+" value="+row.api_availablestock+">"+row.api_availablestock+"</div>";
            return html;
          }
        },
        {
          "mRender": function ( data, type, row ) {
            let html = "<input type='number' name=qty"+row.product_id+" id=qty"+row.product_id+" value='1' min='1'>";
            return html;
          }
        },
      ],
