...
@section('pageJS')
    ...
    <script>
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": SITE_URL + "customer_service/contactus/list",
                "type": "POST",
                "data": function(d) {
            ...
            columns: [{
                ...
                },
                {
                    "mRender": function(data, type, row) {
                        let html =
                            "<div class='btn-group float-left pr-2'><a href='javascript:;' onclick='deleteContactUs(" +
                            row.id +
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            $.ajax({
                                url: SITE_URL + 'customer_service/contactus/delete',
                                type: 'POST',
