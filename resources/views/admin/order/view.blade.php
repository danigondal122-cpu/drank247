                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p class="text-muted">{{ $row->order_id }}</p>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                @if ($row->order_receiptid != '')
                                    <div class="col-md-2">
                                        <strong>Order Receipt Id</strong>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="text-muted">{{ $row->order_receiptid }}</p>
                                    </div>
                                @endif
                                @if ($row->order_note != '')
                                    <div class="col-md-2">
                            ...
                            @if (count($rejected_by) != 0)
                                ...
                                @foreach ($rejected_by as $key => $value)
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            {{ $key + 1 }}. {{ $value['dp_name'] }} @if ($last_dp_id == $value['dp_id'])
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    @if ($row->od_endtime != '' && $row->od_starttime)
                                        <div class="col-md-2">
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        @foreach ($orderdetail as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->od_qty }}</td>
                                                <td>€ {{ str_replace('.', ',', number_format($value->od_vattotal, 2)) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th>€
                                                {{ str_replace('.', ',', number_format($row->order_delivery_charge, 2)) }}
                                            </th>
                                        </tr>
                                        {{--
                  <tr>
                    ...
                    <th></th>
                    <th>Final Amount</th>
                    <th>€ {{str_replace('.',',', number_format($row->order_finalamount,2))}}</th>
                  </tr>
                  --}}
                                        {{-- @if ($row->order_promocode != '') --}}
                                        <tr>
                                            <th></th>
                                            <th></th>
                                            <th>Discount</th>
