...
@section('pageJS')
  ...
  <script>
   ...
   table = $('#table').DataTable({
     ...
     "ajax": {
       "url": SITE_URL + "admin/contactus/list",
       "type": "POST",
       "data": function(d) {
     ...
     columns: [
        ...
        { data: 'message' },
        {
          "mRender": function ( data, type, row ) {
            let html = "<div class='btn-group float-left pr-2'><a href='javascript:;' onclick='deleteContactUs("+row.id+")' class='btn btn-xs btn-danger btn-delete text-white'><i class='fa fa-trash-alt'></i></a></div>";
            return html;
          }
        },
      ],
      ...
      $.confirm({
        ...
        buttons: {
          confirm: {
            ...
            action: function () {
              $.ajax({
                url: SITE_URL + 'admin/contactus/delete',
                type: 'POST',
