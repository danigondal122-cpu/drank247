                ...
                <tr>
                    <td width="600" style="border:1px solid #71CAEA;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td height="30" style="font-size:16px; color:#4d4d4d; font-family:Open Sans; padding:10px 20px;font-weight:bold">Dear  {{$franchises_name}}</td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
                            <tr>
                                <td height="20" style="padding:0px 20px;">Please use below credentials to login in.</td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
                             <tr><td height="20" style="padding:0px 20px;"><b> Email: </b>{{$franchises_email}}</td></tr>
                             <tr>
                             <td height="10"></td>
                             </tr>
                             <tr>
                            ...
                            <tr><td height="20" style="padding:0px 20px;"><b> Password: </b>{{$password}}</td></tr>
                            ...
                            <tr>
                                <td height="20" style="padding:0px 20px;"> Please visit below link to login</td>
                            </tr>
                            <tr>
                                <td height="10"></td>
                            </tr>
                            <tr>
                            <td height="20" style="padding:0px 20px;"><b><a href="{{url('franchise/login')}}">{{url('franchise/login')}}</a></b> </td>
                            </tr>
                            <tr>
