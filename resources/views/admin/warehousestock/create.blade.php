      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">{{ (empty($row)==false)?'Update Product':'Add New Product'}}</h3>
             ...
             @csrf
             <input type="hidden" name="product_id" id="product_id" value="{{ (empty($row)==false)?$row->product_id:''}}">
             <div class="card-body col-sm-12 col-md-6">
                ...
                <div class="row">
                  <div class="col-sm-12"> 
                    <div class="form-group">
                       ...
                       <select name="name" id="name" class="form-control select2 js-example-tags" onchange="getProductDetailFromStock(this.value);">
                        <option value="{{ (empty($row)==false) ? $row->product_name:''}}">{{ (empty($row)==false) ? $row->product_name:'Select Product'}}</option>
                         {{!! $htmlProduct !!}}
                      </select>
                     </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" id="article_number" name="article_number"  value="{{ (empty($row)==false)?$row->product_article_number:''}}">
                     </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" id="price" name="price" onchange="getvatprice()" value="{{ (empty($row)==false)?$row->product_price:''}}">
                     </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                       <label for="first_name">*Vat</label><br>
                       <input type="radio" id="vat0" name="vat" value="0"  {{ (empty($row)==false && $row->vat=="9")?'checked':'checked'}} onchange="getvatprice()">
                       <label class="mr-2">0%</label>
                       <input type="radio" id="vat9" name="vat" value="9" {{ (empty($row)==false && $row->vat=="9")?'checked':''}} onchange="getvatprice()">
                       <label class="mr-2">9%</label>
                       <input type="radio" id="vat21" name="vat" value="21"  {{ (empty($row)==false && $row->vat=="21")?'checked':''}} onchange="getvatprice()">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" id="vat_price" name="vat_price" value="{{ (empty($row)==false)?$row->vat_price:''}}" readonly>
                     </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="alcohol" name="alcohol" value="{{ (empty($row)==false)?$row->alcohol:''}}">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <option value="{{$value->warehouse_id}}"  {{ (empty($row)==false && $row->order_from==$value->warehouse_id)?'selected':''}}>{{$value->wh_name}}</option>
                      @endforeach
                    </select>
                    </div>
                  ...
                  <div class="col-sm-12">
                      ...
                      <select class="form-control select2"  id="allergense" name="allergense[]" placeholder="Select Allergense" multiple="multiple" autocomplete="off" style="width:100% !important;">
                      <option value="" id="selectvalue">Select Allergense</option>
                        @foreach ($allergense  as $value)
                        <option value="{{$value->allergen_id}}"  {{ (empty($row)==false && (in_array($value->allergen_id,$allergense_array)))?'selected':''}}>{{$value->name}}</option>
                        @endforeach
                      </select>
                    </div>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_popular" name="is_popular" {{ empty($row)==true ? 'checked' :(empty($row)==false && $row->is_popular=='1')? 'checked':''}} >
                   ...
                   <div class="col-sm-12">
                    <div class="form-group">
                      <div class="form-check">
                        ...
                        <label class="form-check-label"><b>Show (Do you want to show this Product in Web?) </b></label>
                      </div>
                    </div>
                   </div>
                  </div>
             ...
             <div class="card-footer">
                ...
                <a href="{{ url('admin/product/list') }}" class="btn btn-secondary text-white"> <i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
             </div>
             </form>
           </div>
         </div>
...
<script>
  function getvatprice(){
   ...
   $('#vat_price').val(parseFloat(Finalvat).toFixed(2)); 
  }
