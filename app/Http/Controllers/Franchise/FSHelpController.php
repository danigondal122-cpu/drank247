...
class FSHelpController extends Controller
{
    public function helpList()
    {
        $data['deliverylist'] = DeliveryPerson::get();
        $data['status_list'] = OrderStatus::whereIn('id', [1, 14, 13, 9])->get(); // ??? 13 14 gak ada

        return view('franchise.help.list', $data);
    }
